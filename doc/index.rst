...
**flask-emails** reads configuration from current flask application on :meth:`~Message` object create.

This means that by default you have per-application configuration.

If you need more complex configuration strategy, create :meth:`~EmailsConfig` object and pass it as `config` parameter to ``Message.__init__`` .
...
.. note::
        **flask-emails** is a wrapper for python-emails library.
        See `python-emails project <https://github.com/lavr/python-emails/>`_ for more information on API.
...
.. autoclass:: EmailsConfig
   :members: __init__, smtp_options, message_options, backend_cls
 ...
 * source code: `github.com/lavr/flask-emails <http://github.com/lavr/flask-emails>`_
